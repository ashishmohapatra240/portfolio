  ...
  return (
    <div className="w-full max-w-full md:max-w-2xl h-auto relative">
      <div className="leading-tight">
        <span className="text-black text-5xl md:text-5xl font-normal tracking-tightest">
          a content that defines me in every aspect mention{" "}
        </span>
        <span className="text-black text-5xl md:text-5xl font-bold tracking-tightest">
          designer
        </span>
